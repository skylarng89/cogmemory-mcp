-- CogMemory MCP — SQLite Schema (copied from project root for bundling)
-- Applies to both global (~/.cogmemory/global.db) and workspace (.cogmemory/memory.db) scopes.

------------------------------------------------------------
-- MEMORY: sessions (spine — referenced by decisions/errors/changelog/tasks)
------------------------------------------------------------
